(function () {
    ...
    const data = [
        { study_load: 0, value: 2.57 },
        { study_load: 1, value: 4.21 },
        { study_load: 2, value: 3.35 },
        { study_load: 3, value: 1.95 },
        { study_load: 4, value: 1.30 },
        { study_load: 5, value: 1.69 }
    ];
    ...
    svg.append("text")
        ...
        .text("Average Sleep Quality vs Study Load");
