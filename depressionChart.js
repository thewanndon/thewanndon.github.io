...
const data = [
    { study_load: 0, value: 12.70 },
    { study_load: 1, value: 5.51 },
    { study_load: 2, value: 8.35 },
    { study_load: 3, value: 15.67 },
    { study_load: 4, value: 19.19 },
    { study_load: 5, value: 19.57 }
];
...
const margin = { top: 100, right: 20, bottom: 60, left: 70 };
    ...
    svg.append("text")
        ...
        .text("Average Depression Level vs Study Load");
